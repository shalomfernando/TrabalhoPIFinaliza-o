...
<body background="img/books.jpg">
	...
	<center>
		<font color="white"><h3>
				Bem-Vindo ao Chat Boot<br> ${cliente.nome }<br></font>
					...
					<form name="sentMessage" id="contactForm" novalidate>
						<div class="row control-group">
							<div
								...
								<input type="text" id="pergunta" class="form-control" placeholder="Faça sua pergunta" name="pergunta">
											...
											<div class="bot"
												...
												<c:if
													...
													<div Style="color: aqua">te ajudei com essa resposta?
														...
														<button type="submit" onclick="myFunction()" id="sim"  name="command" value="ButtonSim"style="border:1px solid #999; padding: 1px 3px 2px 3px;">S</button>

													<button onclick="Pesquisa()" type="submit" name="command" value="ValidarResposta" class="btnN btn default btn-xs">N</button>
													<p id="yes"></p>
													<p id="saber"></p>
													<script>
                                                        function myFunction() {
                                                            document.getElementById("yes").innerHTML = "Obrigado. ";
                                                        ...
                                                        function Pesquisa() {
                                                            ...
                                                            if(contCLick==1){
                                                                ...
                                                                contClick1++;
                                                                //ta dando errado
                                                                document.getElementById("saber").innerHTML = value(contClick1);
                                                            }
												...
												<c:if
													...
													<button type="submit" name="command" value="ContarTentativas"> Clique aqui para falar com
														atendente</button>
